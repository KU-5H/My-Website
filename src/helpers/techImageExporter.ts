export const techLanguages = [
    ...
    {
        src: 'https://www.dropwizard.io/en/stable/_images/dropwizard-logo.svg',
        name: 'Dropwizard',
        href: 'https://www.dropwizard.io/en/stable/'
    },
    {
    ...
    {
        src: 'https://www.vectorlogo.zone/logos/w3c_xml/w3c_xml-icon.svg',
        name: 'XML',
    ...
    {
        src: 'https://www.vectorlogo.zone/logos/common-lispnet/common-lispnet-icon.svg',
        name: 'Common Lisp',
...
export const techTools = [
    ...
    {
        src: 'https://upload.wikimedia.org/wikipedia/commons/3/30/MacOS_logo.svg',
        name: 'macOS',
