...
export const ecoDexText: string = "Using Javascript with Next.JS, Python with Flask, and OpenAI’s ChatGPT API to create an environmental based, mobile focused website to help organize, categorize and educate users on waste management.";   
