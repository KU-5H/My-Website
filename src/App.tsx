...
function App() {
  ...
  const handleGithubMouseEnter = () => {
    githubTimeoutRef.current = setTimeout(() => {
      console.log('Github wants to spin');
  ...
  const handleGithubMouseLeave = () => {
    if (githubTimeoutRef.current) {
      console.log('Github wants to stop spinning');
  ...
  return (
    <div className="font-sans text-white bg-gray-900 min-h-screen flex flex-col items-center justify-center text-center px-4">
      <div className="max-w-screen-xl mx-auto grid grid-cols-1 gap-4 p-8 md:grid-cols-[auto,1fr,auto]">
        <div className="order-1 md:order-1 flex flex-col items-center space-y-4 max-w-xs">
        ...
        <div className="order-2 md:order-3 flex flex-col items-center p-8 rounded-lg bg-glass">
          <p className="text-lg">Placeholder for Nav Bar</p>
        </div>
        <div className="order-5 md:order-5 col-span-1 md:col-span-3 p-8 w-full rounded-lg bg-glass mt-4">
          <p className="text-lg">Placeholder for Tech Stack</p>
        </div>
      </div>
    </div>
  );
